...
#noinspection DuplicatedCode
class MonteCarloTreeSearchProgressiveWideningAgent:
    def __init__(self, game, simulations=1000, exploration_constant=sqrt(2), rng=None, chance_policy=None, rollout_policy=None, k=1, alpha=0.5):
        if simulations <= 0:
